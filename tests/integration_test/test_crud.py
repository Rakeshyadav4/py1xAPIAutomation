...
class TestCreateBooking(object):
    ...
    def test_update_booking(self): # Token and Booking ID from the Create Booking, Token
        ...
        put_url = APIConstants.url_create_booking() + "/1163"  # here we are hard coded the booking number.
...
# In your test module or conftest.py
import pytest

pytest.mark.negative = pytest.mark.mark(name="negative")
